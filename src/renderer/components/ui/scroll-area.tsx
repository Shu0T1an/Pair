...
>(({ className, orientation = 'vertical', ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      ...
      orientation === 'vertical' && 'h-full w-3 border-l border-l-transparent p-[2px] hover:w-3.5',
      orientation === 'horizontal' && 'h-3 flex-col border-t border-t-transparent p-[2px] hover:h-3.5',
      className
    )}
    {...props}
  >
